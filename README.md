...
| Training data |  Aligned modalities |  Embeddings |  Model  | Config | Package |  
|---------------|---------------------|-------------|---------|--------|---------|
