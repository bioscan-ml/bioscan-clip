...
def write_latex_content(args, dataset=True, alignment=True):
    ...
    if args.full_table:
        ...
        latex_strings += "\\cmidrule(){%d-%d} \\cmidrule(l){%d-%d} \\cmidrule(l){%d-%d} " % (column_starter, column_starter+2, column_starter+3, column_starter+5, column_starter+6, column_starter+8)
        if alignment:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--full_table", action="store_true", help="Write the full table, including the header and footer")
