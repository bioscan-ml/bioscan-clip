...
def main(args: DictConfig) -> None:
    ...
    print("For seen test: ")
    encode_image_feature_and_calculate_accuracy(model, key_features, key_labels, seen_test_dataloader)
    print()

    print("For unseen test: ")
    encode_image_feature_and_calculate_accuracy(model, key_features, key_labels, unseen_test_dataloader)
